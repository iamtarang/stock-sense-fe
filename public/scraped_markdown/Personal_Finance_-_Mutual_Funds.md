...
[Read more](https://zerodha.com/varsity/chapter/the-mutual-fund-portfolio/)
...
## 28.Asset_Allocation,_An_Introduction

[Read more](https://zerodha.com/varsity/chapter/asset-allocation-an-introduction/)
...
[Read more](https://zerodha.com/varsity/chapter/smart-beta-funds/)
...
## 25.How_to_analyze_a_debt_mutual_fund

[Read more](https://zerodha.com/varsity/chapter/how-to-analyze-a-debt-mutual-fund/)
...
## 23.Sortino_and_the_Capture_Ratios

[Read more](https://zerodha.com/varsity/chapter/sortino-and-the-capture-ratios/)
...
Further, I calculate the excess return by subtracting the average return from the actual return. For example, the daily return for 4 th  August 2020 was 1.23%, the average return is 0.108%.
...
## 22.Mutual_Fund_Beta,_SD,_and_Sharpe_Ratio

[Read more](https://zerodha.com/varsity/chapter/mutual-fund-risk-metrics/)
...
## 20.Mutual_fund_Expense_Ratio,_Direct,_and_Regular_plans

[Read more](https://zerodha.com/varsity/chapter/mutual-fund-expense-ratio-direct-and-regular-plans/)
...
## 21.Mutual_Benchmarking

[Read more](https://zerodha.com/varsity/chapter/mutual-benchmarking/)
...
Pick any Mutual fund of your choice. I’ve picked IDFC Core Equity Fund, Growth. Arbitrarily assume a starting date and a SIP amount, I’ve picked Rs.10,000/- as the monthly SIP amount, starting from 1 st  Jan 2014. I further assumed that the SIP is continued over five years, i.e. till 1 st  Jan 2020.
...
1. The total amount invested is Rs.7,30,000/- across 73 months.
1. The total number of units acquired is 20,772.43
1. The value of the investment after 73 months of regular investment is Rs.9,52,000/-
...
1. The MF generates lower returns compared to the benchmark; then the fund is said to have under-performed
...
1. MF’s use TRI as a benchmark; this is a recent phenomenon though. Earlier, MFs were benchmarking against just the price appreciation chart.
1. It’s not easy to beat the TRI index.  😊
...
[Read more](https://zerodha.com/varsity/chapter/rolling-returns/)
...
The 2 nd  rolling return in this series would be –
...
1. Find out the historical rolling return min, max, and average for the period
...
1. Point to point return should not be taken as a generalization of return
1. The rolling return gives a better perspective of the return
1. Rolling return average is a better representation of the returns one can expect



## 15.Investing_in_Bonds

[Read more](https://zerodha.com/varsity/chapter/investing-in-bonds/)
...
1. The coupon is paid as a percentage of the face value. The coupon for this bond is 8.01%, which means that every bond you hold gives you Rs.80.01/- as interest income until it matures.
1. Upon maturity, the redemption value depends on the bond’s face value. More on this later.

The next section highlights the interest payment details. As highlighted, the REC bond pays the interest on 1 st  Dec every year, till the bond matures. The company pays out interest annually. Some bonds pay interest semiannually, quarterly, and some even pay monthly.

You can also see the maturity date, which is 24 th  September 2023.
...
The coupon of Rs.80.01/- gets paid once a year or once in 365 days. We know the date of payment is the 1 st  December every year.

The last coupon was paid on 1 st  December 2019, and the next coupon will be paid on 1 st  December 2020. Between the previous coupon paid and the next coupon date, interest accrues daily.
...
Today is 21 st  May 2020; it is 172 days since the last coupon paid. Therefore, by holding this bond for 172 days, the owner of this bond is entitled to receive –
...
[Read more](https://zerodha.com/varsity/chapter/arbitrage-funds/)
...
All of us, at some point in life, would have carried out an arbitrage transaction. For example, when I was in my 1 st -year college, I’d pay my cousin in Singapore to buy me Rock n Roll audio cassettes from Rs.100/- per tape and sell the same here in Bangalore for Rs.150/-. People here would happily buy the tape at Rs.150/- because there was no other source for them to buy these tapes.
...
As of today, i.e. 18 th  June 2020, the stock price of Maruti is at Rs.5,714.4/- per share. However, Maruti’s future’s is trading at Rs.5,735.6/-.
...
1. SEBI mandates AMCs to invest a minimum of 65% in arbitrage strategies
1. Mutual funds usually spend up to 35% in debt
1. Arbitrage funds can be volatile
1. One can consider Arbitrage funds as a proxy for low/short duration funds



## 12.The_Debt_funds_(Part_2)

[Read more](https://zerodha.com/varsity/chapter/the-debt-funds-part-2/)
...
## 11.The_Debt_funds_(Part_1)

[Read more](https://zerodha.com/varsity/chapter/the-debt-funds-part-1/)
...
1. Liquid funds
1. Overnight funds
1. Ultrashort term funds
1. Medium duration
1. Dynamic bonds
1. Corporate bond
1. Credit Risk
1. Banking & PSU
1. GILT funds (2 different types)
...
If the company takes the 1 st  approach and seeks a loan from the bank, then the binding agreement is called the ‘loan agreement’. On the other hand, if the company decides to raise this money from multiple investors (multiple lenders), then the binding agreement is called ‘ bond ’.
...
1. 182-day T-Bill, the maturity of 182 days
1. 365 day T-bills, the maturity of 364 days
...
## 13.The_Debt_funds_(Part_3)

[Read more](https://zerodha.com/varsity/chapter/the-debt-funds-part-3/)



### 13.1 – Debt jargons

As we enter the 27 th  day of the nationwide lockdown, I hope you and your loved ones are staying home, staying safe. The number of COVID19 cases in India has crossed 17,000 with Maharashtra topping the charts with over 3,500 cases. I hope all of this ends soon and we can all get back to our normal lives, until then the only mantra is ‘social distancing’, I hope you are following this diligently.
...
On 23 rd  April 2020, Franklin Templeton (India) AMC made an announcement that shook the entire debt fund world.
...
## 18.Measuring_Mutual_fund_Returns

[Read more](https://zerodha.com/varsity/chapter/measuring-mutual-fund-returns/)
...
1. For SIP investments less than one year, use absolute return
1. For lumpsum investments over a year use CAGR
1. For SIP investments over a year, use XIRR
1. CAGR is the growth rate of an investment
1. XIRR is a modified form of CAGR
1. CAGR and XIRR are same for lumpsum investments over 1 year



## 8.The_mutual_fund_fact-sheet

[Read more](https://zerodha.com/varsity/chapter/the-mutual-fund-fact-sheet/)
...
1. Investments are in Equity and equity-related securities. This is mainly stocks
1. Investments are predominantly in the small market capitalisation companies, which means as the fund name suggests, they look at investments in the small-cap company
1. The second section talks a bit about how they intend to research these small-cap stocks. Frankly, this should not be of concern to you. I mean think about it – if you knew what to look for when investing in a stock or if you had an opinion on what makes a good stock, then you are better off investing in the stocks directly right? Why mutual funds at all?
...
Next up is the SIP details. SIP stands for ‘systematic investment plan’. In a typical SIP, you will invest the same amount of money every month for as many years as possible. Example of a SIP is investing say Rs.5000/- in Kotak Small-cap fund on 5 th  of every month for as many months as possible. Think of SIP as investing in instalments. SIP is perhaps one of the most significant financial inventions and has many merits to it. Given the importance of this topic, I think a separate chapter on this topic is justified, and we will do that at a later point. For now, think of SIP in its basic form, i.e. to invest a fixed amount of money every month in the same fund for many years.
...
1. The investment objective of a fund is essentially the guiding principle for the investment the fund manager makes
1. Open-ended funds don’t have an ‘expiry’ for the fund. It can go on forever
1. Close-ended funds are time-bound
1. Regular plans pay out distributor commissions, hence lower yield to investors
1. The direct plan does not pay distributor commissions; hence the returns are higher for the investor
1. The MF investor can choose to receive or reinvest the dividends
1. Riskometer is a self-assessment of risk by the AMC



## 10.Equity_Scheme_(Part_2)

[Read more](https://zerodha.com/varsity/chapter/equity-scheme-part-2/)
...
## 7.Concept_of_fund_&_NAV

[Read more](https://zerodha.com/varsity/chapter/concept-of-fund-nav/)
...
## 6.Introduction_to_Mutual_Funds

[Read more](https://zerodha.com/varsity/chapter/introduction-to-mutual-funds/)
...
1. Build an investment thesis for each stock
1. Estimate the amount of money to invest in each stock
1. Build an equity portfolio
1. Track individual stock and overall portfolio
1. Measure the returns, performance, and risk at periodical intervals
1. Report to clients
...
1. An Asset Management Company (AMC), is a company where a fund manager works and manages your money
1. Think of the ‘Mutual Fund structure’, as a vehicle or mechanism to manage your funds
...
## 9.The_Equity_scheme_(Part_1)

[Read more](https://zerodha.com/varsity/chapter/the-equity-scheme-part-1/)
...
Large-cap stocks  – 1 st  to 100 th  company in terms of full market capitalisation

Mid-cap stocks  – 101 st  to 250 th  company in terms of full market capitalisation

Small-cap stocks  – 250 th  company onwards in terms of full market capitalisation
...
1. Large-cap stocks – 1 st  to 100 th  company in terms of full market capitalization
1. Mid-cap stocks – 101 st  to 250 th  company in terms of full market capitalization
1. Small-cap stocks – 250 th  company onwards in terms of full market capitalisation
1. Large-cap funds should contain at least 80% in large-cap stocks. Large-cap funds are expected to have lower volatility and steady returns
1. Mid-cap and small-cap funds have higher volatility and return expectation compared to the large-cap funds
1. Mid and large-cap stocks contain at least 35% each of mid and large-cap stocks.



## 5.The_retirement_problem_(Part_2)

[Read more](https://zerodha.com/varsity/chapter/the-retirement-problem-part-2/)
...
The 2 nd  row reads similar – Its February, I’m making the 2 nd  savings installment for the year, i.e. Rs.5000/-. Retirement is now 299 months away.

I want you to recognize the fact that the ‘months away’ can be looked at from a different perspective. If you realize, these are the number of months during which your money can grow. For example, the very first installment you make has the luxury to build (or compound) for 300 full months. The next month’s savings can grow only for 299 months, 3 rd  installment has only 298 months to grow. So on and so forth.

Now, the 5 th  and 6 th  assumptions state that we are increasing the savings rate by 10% every January.  This means, if we are starting with Rs.5000/- for year 1, the 2 nd  year we bump this up by 10%, hence for the 2 nd  year we invest Rs.5,500/-.

This is how it looks –

The month counting continues the same way. For example, the Rs.5,500/- investment we make in the 2 nd  year January has only 288 months to grow or compound.
...
Let us do this for the 2 nd  installment as well; everything stays the same except for the time component –
...
[Read more](https://zerodha.com/varsity/chapter/introduction-to-index-funds/)
...
## 14.The_Debt_Funds_(Part_4)

[Read more](https://zerodha.com/varsity/chapter/the-debt-funds-part-4/)
...
As you can see, the cash component turned negative in March 2020, which means to say that the AMC had borrowed funds, showing some early signs of liquidity stress. Franklin folded this particular fund along with five others on 23 rd  April 2020. So there was some warning on the wall.
...
## 3.Personal_Finance_Math_(Part_2)

[Read more](https://zerodha.com/varsity/chapter/personal-finance-math-part-2/)
...
1. How do you move money across a timeline to ensure we compare the right value of money?
...
## 4.The_retirement_problem_(Part_1)

[Read more](https://zerodha.com/varsity/chapter/the-retirement-problem-part-1/)
...
The table is quite easy to understand. Look at the first row, it says, the 1 st  retirement year is 2044, and it is 25 years from the current year i.e.2019. The corpus required for 2044 is Rs.600,000/-. This is a constant amount needed for all the retirement years.

The 2 nd  retirement year is 2045, which is 26 years away from the current year (2019). So on and so forth.
...
## 1.Background_and_Orientation

[Read more](https://zerodha.com/varsity/chapter/background-and-orientation/)
...
A father had triplet daughters. On their 20 th  birthday, the father declared that he would pay each daughter a sum of Rs.50,000/- on their birthday, till they were 65 years old. They were free to use this money in whichever way they wanted.
...
- The first daughter started investing right away i.e on her 20 th  birthday. She invested the first nine 50Ks that she received in the promissory note, and then the remaining 50K that she received (from 28th birthday to her  65th birthday) were all spent on frivolous things.
- The second daughter initially spent all the money she received. However, on her 28 th  birthday, she got a little serious. She decided to save the same amount as her other sister. So she saved 50K from her 28 th  birthday till her 36 th  birthday, and the money she received from 37 th  to 65 th  was spent.
- The 3 rd  sister was a bit casual till her 28 th  birthday. She spent all the money she received from her dad. However, on her 28 th  birthday, she got a little serious and decided to invest the 50k cash all the way up to 65 years.

Here is a summary of what each sister did with the money –

- The first sister saved for the first 9 years (between 20 th  to 36 th  birthday) totaling Rs.450,000/-.
- The 2 nd  sister saved for 9 years (between her 28 th  birthday to 36 th  birthday), totaling Rs.450,000/-
- The 3 rd  sister started saving from her 28 th   birthday, but saved all the way till her 65 th  birthday, totaling a sum of Rs.1,900,000/-

I have a question for you now – on the 65 th  birthday, which sister do you think would have saved the most? Remember, once the money gets invested the promissory note, it gets locked till the 65th birthday and do not forget the promissory note gives a 12% compounded return year on year.
...
- The 2 nd  sister again has saved very little very randomly, so she may not have much on her 65 th  birthday
- The 3 rd  sister, although started late, has saved quite a bit and continued to save for the entire duration, hence she must have the highest savings on her 65th birthday
...
- The 3 rd  sister saves 19L, which grows to a massive 3.05Crs by the time she turns 65
- The 2 nd  sister saves 4.5L, which grows to an impressive 1.98Crs by the time she turns 65
- The 1 st  sister saves 4.5L, however, she ends up with a whopping 4.89Crs by the time she turns 65!

Are you confused?

I’m sure some of you are. So here is what I want you to note –

- The first and 2 nd  sister saved similar amounts, but the difference was the amount of time they both gave their money to grow. The first sister gave full 45 years for the investment to grow, but the 2 nd  sister gave only 38 years. See the difference it makes? This is the reason why I regret not starting to save early on in my life
- The 3 rd  sister ends up with the 2 nd  highest corpus, but for to that happen she had to save for a very long time. But please note, this still does not match up to the 1 st  sister’s corpus.
...
## 2.Personal_Finance_Math_(Part_1)

[Read more](https://zerodha.com/varsity/chapter/personal-finance-math-part-1/)
