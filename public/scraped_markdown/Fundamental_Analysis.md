...
1. Inventory number of days represents the number of days the company takes to convert its inventory to cash
...
1. Return on Capital employed indicates the overall return the company generates considering both the equity and debt.
...
1. A business will generally need a balance sheet when it seeks investors, applies for loans, submits taxes etc.
1. Balance sheet equation is Assets = Liabilities + Shareholders’ Equity.
1. Liabilities are obligations or debts of a business from past transactions, and Share capital is the number of shares * face value.
1. Reserves are the funds earmarked for a specific purpose, which the company intends to use in future.
1. The surplus is where the profits of the company reside. This is one of the points where the balance sheet and the P&L interact. Dividends are paid out of the surplus.
1. Shareholders’ equity = Share capital + Reserves + Surplus. Equity is the claim of the owners on the assets of the company. It represents the assets that remain after deducting the liabilities if you rearrange the Balance Sheet equation, Equity = Assets – Liabilities.
1. Non-current liabilities or the long-term liabilities are expected to be settled in not less than 365 days or 12 months of the balance sheet date.
1. Deferred tax liabilities arise due to the discrepancy in the way the depreciation is treated. Deferred tax liabilities are amounts of income taxes payable in the future concerning taxable differences as per accounting books and tax books.
1. Current liabilities are the company’s obligations to settle within 365 days /12 months of the balance sheet date.
1. In most cases, both long and short term provisions are liabilities dealing with employee-related matters
1. Total Liability = Shareholders’ Funds + Non-Current Liabilities + Current Liabilities. . Thus, total liabilities represent the total amount of money the company owes to others



## 8.The_Cash_Flow_statement

[Read more](https://zerodha.com/varsity/chapter/cash-flow-statement/)
...
1. Hire fitness instructors to help clients in their fitness workout
1. Buy new fitness types of equipment to replace worn-out equipment.
1. Seek short term loan from bankers
1. Issue a certificate of deposit for raising funds
1. Issue new shares to a few known friends to raise fresh capital for expansion (also called preferential allotment)
1. Invest in a startup company working towards innovative fitness regimes
1. Park excess money (if any) in fixed deposits
1. Invest in a building coming up in the neighbourhood, for opening a new fitness centre sometime in the future
1. Upgrade the sound system for a better workout experience
...
1. Investing activities (IA):  Activities about investments that the company makes intending to reap benefits at a later stage. Examples include parking money in interest-bearing instruments, investing in equity shares, investing in land, property, plant and equipment, intangibles and other non-current assets etc.
1. Financing activities (FA):  Activities about all financial transactions of the company such as distributing dividends, paying interest to service debt, raising fresh debt, issuing corporate bonds etc
...
1. Hire fitness instructors to help customers with their fitness workout –  OA
1. Buy new fitness equipment to replace worn-out equipment –  OA.
1. Seek a short term loan from bankers –  FA
1. Issue a certificate of deposit (CD) for raising funds –  FA
1. Issue new shares to few known friends to raise fresh capital for expansion (also called preferential allotment) –  FA
1. Invest in a startup company working towards innovative fitness regimes –  IA
1. Park excess money (if any) in fixed deposit –  IA
1. Invest in a building coming up in the neighbourhood for opening a new fitness centre sometime in the future –  IA
1. Upgrade the sound system for better workout experience-  OA
...
--- | --- | --- | --- | ---
01 | OA | Expenditure on advertisement | Decreases | Treated as an
02 | OA | Expenditure towards recruits | Decreases | Treated as an
03 | OA | Expenditure on new equipment | Decreases | Treated as
04 | FA | Loan means cash inflow to business | Increases | The loan is a
05 | FA | Deposits via CD means cash inflow | Increases | CD is a
06 | FA | Issue of fresh capital means cash inflow | Increases | Treated as a
07 | IA | Investment in a startup means cash outflow | Decreases | Investment is an
08 | IA | Money parked in FD means cash going out of business | Decreases | Equivalent to cash, hence considered an
09 | IA | Investment in the building means cash going out of business | Decreases | Gross block considered an
10 | OA | Expenditure towards the sound system | Decreases | Treated as an


The table above is colour coded:

1. Increase in cash is colour coded in blue
1. The decrease in cash is colour coded in red
1. Assets are colour coded in green and
1. Liabilities are colour coded in purple.
...
1. Whenever the asset of the company increases, the cash balance decreases.
...
Note, the closing balance of 2013-14 will now be the opening balance for the FY 2014 – 15. You can watch out for this when ARBL provides its cash flow numbers for the year ended 31 st  March 2015.
...
1. Are liquid assets similar to ‘current items’ that we looked at in the Balance sheet?
 
 Yes, you can think of it that way.
1. Yes, you can think of it that way.
1. If cash is current and cash is an asset, shouldn’t it reflect under the Balance sheet’s current asset?
...
1. A legitimate company has three main activities – operating activities, investing activities and the financing activities.
1. Each activity either generates or drains money for the company.
1. The company’s net cash flow is the sum of operating activities, investing activities, and financing activities.
1. Investors should specifically look at the cash flow from operating activities of the company.
1. When the liabilities increase, cash level increases and vice versa
1. When the assets increase, cash level decreases and vice versa.
1. The net cash flow number for the year is also reflected in the balance sheet.
1. The Statement of Cash flow is a useful addition to a company’s financial statements because it indicates the company’s performance.



## 7.Understanding_the_Balance_Sheet_Statement_(Part_2)

[Read more](https://zerodha.com/varsity/chapter/understanding-balance-sheet-statement-part-2/)



### 7.1 – The Assets side of Balance Sheet

In the previous chapter, we looked at the liability side of the balance sheet in detail. We will now understand the 2 nd  half of the balance sheet, i.e. the Asset side of the balance sheet. The Asset side shows us all the company’s assets (in different forms) right from its inception. Assets in simple terms are the resources held by a company, which help in generating the revenues. Here is the snapshot of the Assets side of the balance sheet:
...
As of 31 st  March 2013 (FY13), ARBL has depreciated Rs.17.2 Crs, to which they need to add Rs.2.8 Crs belonging to the year FY14, adjust 0.376 Crs as the deduction for the year. Thus, the Total Depreciation for the year is:-
...
1. Assets are expected to give an economic benefit during its useful life.
1. Assets are classified as Non-current and Current asset.
1. The useful life of Non-current assets is expected to last beyond 365 days or 12 months.
1. Current assets are expected to pay off within 365 days or 12 months.
1. Assets inclusive of depreciation are called the ‘Gross Block.’
1. Net Block = Gross Block – Accumulated Depreciation
1. The sum of all assets should equal the sum of all liabilities. Only then the Balance sheet is said to have balanced.
1. The Balance sheet and P&L statement are inseparable. They are connected in many ways.



## 12.The_Investment_Due_Diligence

[Read more](https://zerodha.com/varsity/chapter/investment-due-diligence/)
...
1. Application of the checklist and
1. Valuation – to estimate the intrinsic value of the business
...
1. Circle of competence and General observation is a great way to start.
1. It is advisable to have a watch list which includes stocks that look interesting.
1. Once a stock is identified, we should look for sustainable moats.
1. The due diligence process involves understanding the business, running the checklist to understand its financial performance, and the valuation exercise.
1. When it comes to an understanding the business, one should be completely thorough with the company’s business operation.
1. The checklist should be improvised as and when the investor gains investment experience.
1. The DCF method is one of the best techniques to identify the intrinsic value of the business



## 5.Understanding_P&L_Statement_(Part_2)

[Read more](https://zerodha.com/varsity/chapter/understanding-pl-statement-part2/)
...
1. Each expense can be studied concerning a note which you can explore for further information.
1. Depreciation and amortization is a way of spreading the cost of an asset over its useful life.
1. The cost of interest and other charges paid when the company borrows money for its capital expenditure.
1. PBT = Total Revenue – Total Expense – Exceptional items (if any)
1. Net PAT = PBT – applicable taxes
1. EPS reflects the earning capacity of a company on a per-share basis. Earnings are profit after tax and preferred dividends.
1. EPS = PAT / Total number of outstanding ordinary shares



## 4.Understanding_the_P&L_Statement_(Part_1)

[Read more](https://zerodha.com/varsity/chapter/understanding-pl-statement-part1/)
...
1. The expenses incurred to generate the revenues
1. Tax and depreciation
1. The earnings per share number
...
1. The statement of P&L for the year  ending  March 31, 2014, hence this is an annual statement and not a quarterly statement. Also, since it is as of March 31 st  2014, it is evident that the statement is for the Financial Year 2013 – 2014 or it can be referred to as the FY14 numbers.
1. All currency is denominated in Rupee Million. Note – 1 Million Rupees is equal to Ten Lakh Rupees. It is upto the company’s discretion to decide which unit they would prefer to express their numbers in
1. The particulars show all the main headings of the statement. Any associated note to the particulars is present in the note section (also called the schedule). An associated number is assigned to the note (Note Number)
1. By default, when companies report the numbers in the financial statement, they present the current year number on the left-most column and the previous year number to the right. In this case, the numbers are for FY14 (latest) and FY13 (previous)
...
1. Sale of Storage batteries (stock in trade) is Rs.208 Crs in FY14 versus 149 Crs. Stock in trade refers to finished goods of previous financial year being sold in this financial year.
1. Sale of home UPS (stock in goods) is at Rs.71 Crs in FY14 versus Rs.109 Crs FY13
1. Net sales from sales of products adjusted for excise duty amounts to Rs.3403 Crs, matching the number reported in the P&L statement.
1. Likewise, you can notice the split up for revenue from services. The revenue number of Rs.30.9 tallies with the number reported in the P&L statement
1. In the note, the company says the “Sale of Process Scrap” generated revenue of Rs.2.1 Cr. Note that the sale of process scrap is incidental to the operations of the company, hence reported as ‘Other operating revenue”.
1. Adding up all the revenue streams of the company, i.e. Rs.3403 Crs+ Rs.30.9 Crs +Rs.2.1 Crs gets us the Net revenue from operations = Rs.3436 Crs.
1. You can also find similar split up for FY13
...
1. A complete set of financial statements include the Profit & Loss Account, Balance Sheet and Cash Flow Statement.
1. A fundamental Analyst is a financial statement user, and he needs to know what the maker of the financial statements states.
1. The profit and loss statement gives the profitability of the company for the year under consideration.
1. The P&L statement is an estimate, as the company can revise the numbers at a later point. Also, by default, companies publish data for the current year and the previous year, side by side.
1. The revenue side of the P&L is also called the top line of the company.
1. Revenue from operations is the main source of revenue for the company.
1. Other operating income includes revenue incidental to the business.
1. The other income includes revenue from non-operating sources.
1. The sum of revenue from (operations less of duty) and other operating income gives the “net revenue from operations”.



## 3.How_to_Read_the_Annual_Report_of_a_Company

[Read more](https://zerodha.com/varsity/chapter/read-annual-report-company/)



### 3.1 – What is an Annual Report?

The annual report (AR) is a yearly publication by the company and is sent to the shareholders and other interested parties. The annual report is published by the end of the Financial Year, and all the data made available in the annual report is dated to 31 st  March. The AR is usually available on the company’s website (in the investor’s section) as a PDF document, or one can contact the company to get a hard copy of the same.
...
1. Consolidated financial statement or simply consolidated numbers
...
1. Public and other Financial institutions hold the balance of 49% of shares of CRISIL.
1. However, S&P itself is 100% subsidiary of another company called ‘The McGraw-Hill Companies’
...
1. Further, CRISIL itself fully owns (100% shareholding) another company called ‘Irevna’.
...
1. The AR is the best source to get information about the company; hence AR should be the default choice for the investor to source company-related information.
1. The AR contains many sections, with each section highlighting a certain aspect of the business.
1. The AR is also the best source to get information related to the qualitative aspects of the company.
1. The management discussion and analysis is one of the most important sections in the AR. It has the management’s perspective on the country’s overall economy, their outlook on the industry they operate in for the year gone by (what went right and what went wrong), and what they foresee for the year ahead.
1. The AR contains three financial statements – Profit & Loss Statement, Balance Sheet, and Cash Flow statement.
1. The standalone statement contains the financial numbers of only the company into consideration. However, the consolidated numbers contain the company and its subsidiaries financial numbers.



## 2.Mindset_of_an_Investor

[Read more](https://zerodha.com/varsity/chapter/mindset-investor/)
...
1. Withdraw the profits of Rs.20.

You decide not to withdraw Rs.20 profit; instead, you decide to reinvest the money for the 2 nd  year. At the end of the 2 nd  year, Rs.120 grows to Rs.144. At the end of 3 rd  year, Rs.144 grows to Rs.173. So on and so forth.

Compare this with withdrawing Rs.20 profits every year. Had you opted to withdraw Rs.20 every year than at the end of 3 rd  year the profits would have been just Rs. 60.
...
1. Business ethics  – is the management involved in scams, bribery, unfair business practices.
1. Corporate governance  – Appointment of directors, organization structure, transparency etc
1. Minority shareholders  – How does the management treat minority shareholders, do they consider their interest while taking corporate actions
1. Share transactions  – Is the management buying/selling shares of the company through clandestine promoter groups.
1. Related party transactions  – Is the company tendering financial favours to known entities such as promoter’s relatives, friends, vendors etc. at the cost of the shareholder’s funds?
1. Salaries paid to promoters  – Is the management paying themselves a hefty salary, usually a percentage of profits.
1. Operator activity in stocks  – Does the stock price display unusual price behaviour, especially when the promoter is transacting in the shares.
1. Shareholders  – Who are the significant shareholders in the firm, who are the people with above 1% of the outstanding shares of the company
1. Political affiliation  – Is the company or its promoters too close to a political party? Does the business require constant political support?
1. Promoter lifestyle –  Are the promoters too flamboyant and loud about their lifestyle? Do they like to display their wealth?
...
1. Margins and its growth
1. Earnings and its growth
1. Matters related to expenses
1. Operating efficiency
1. Pricing power
1. Matters related to taxes
1. Dividends payout
1. Cash flow from various activities
1. Debt – both short term and long term
...
1. The investor has to develop an investment mindset if he is serious about investing.
1. The investor should stay invested for a long period of time for the returns to compound.
1. The speed at which the money doubles increases drastically the more time you stay invested. This is one of the properties of compounding.
1. Every investment has to be evaluated on two aspects – qualitative & quantitative.
1. Qualitative aspects revolve around the non-numeric information related to the company.
1. The quantitative aspects involve analyzing numeric data. The financial statements are an important source of finding quantitative data.



## 1.Introduction_to_Fundamental_Analysis

[Read more](https://zerodha.com/varsity/chapter/introduction-fundamental-analysis/)
...
1. Understand businesses concerning the industry in which it operates
1. Basic arithmetic operations such as addition, subtraction, division, and multiplication
...
1. Industry-related data – You will need industry data to see how the company under consideration is performing concerning the industry. Basic data is available for free and is usually published in the industry’s association website
1. Access to the news – Daily News helps you stay updated on the latest developments in the industry and the company you are interested in. A good business newspaper or services such as Google Alert can help you stay abreast of the latest news
1. MS Excel – Although not free, MS Excel can be extremely helpful in fundamental calculations
...
1. Investment in a company with good fundamentals creates wealth.
1. Using Fundamental Analysis, one can separate an investment-grade company from a junk company.
1. All investment-grade companies exhibit a few common traits. Likewise, all junk companies exhibit common traits.
1. Fundamental analysis helps the analysts identify these traits.
1. Both Technical analysis and fundamental analysis should coexist as a part of your market strategy.
1. To become a fundamental analyst, one does not require any special skill. Common sense, basic mathematics, and a bit of business sense are all that is required.
1. A core-satellite approach to capital allocation is a prudent market strategy.
1. The tools required for FA are generally fundamental; most of these tools are available for free.
